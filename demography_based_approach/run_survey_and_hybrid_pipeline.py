...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--fe-config",
        type=Path,
        default=Path("/code/demography_based_approach/feature_engineering/feature_engineering_config.json"),
        help="Path to feature engineering config JSON.",
    )
    parser.add_argument(
        "--train-config",
        type=Path,
        default=Path("/code/demography_based_approach/survey_and_hybrid_approach_pipeline/config.json"),
        help="Path to training config JSON.",
    )
    parser.add_argument(
        "--survey-features",
        type=Path,
        default=Path("/code/demography_based_approach/survey_and_hybrid_approach_pipeline/all_features_plus_neighbours.csv"),
    ...
    parser.add_argument(
        "--analysis-output",
        type=Path,
        default=Path("/code/demography_based_approach/feature_engineering/feature_engineering_report.md"),
    ...
    parser.add_argument(
        "--plots-dir",
        type=Path,
        default=Path("/code/demography_based_approach/feature_engineering/plots"),
...
if __name__ == "__main__":
    print("Begining the demography and hybrid approach ..")
    main()
    print("Ended the demography and hybrid approach ..")
